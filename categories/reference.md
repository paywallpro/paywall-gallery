...
A curated collection of iOS subscription paywalls from reference apps.

Reference apps use subscription paywalls to communicate value and convert users into paid plans.

## Apps

| App | Estimated MRR | Pattern | Page |
|---|---:|---|---|
| Hallow: Prayer & Meditation | $672.17K | Free Trial - Soft Paywall, No Free Trial - Soft Paywall | [Open](../apps/hallow-prayer-and-meditation-1405323394.md) |
